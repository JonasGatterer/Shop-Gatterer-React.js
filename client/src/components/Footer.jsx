...
const Footer = () => {
    return(
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" id="leftContainer">
                <p>Öffnungszeiten:</p>
                <ul>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7" id="rightContainer">
                <form action="">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="messageInput" class="form-label">Text:</label>
